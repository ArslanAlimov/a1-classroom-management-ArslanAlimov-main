...
public class Classroom {
    ...
    public void registerStudent(Student student) {
        ...
        registeredStudents.putIfAbsent(student.getId(), student);
    }
    ...
    public ArrayList<String> getEnrolledStudents() {
        ...
        ArrayList<String> enrStudents = new ArrayList<>();
        enrolledIds.forEach(x -> {
            enrStudents.add(registeredStudents.get(x ).getName());
        });
        return enrStudents;
    }
    ...
    public ArrayList<String> getWaitlistedStudents() {
        ...
        for(int i:waitlistIds){
            stack.add(registeredStudents.get(i).getName());
        }
        while(!stack.isEmpty()) {
